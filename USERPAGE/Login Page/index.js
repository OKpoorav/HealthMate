...
function handleGoogleAuth(response) {
    if (response.credential) {
        ...
        window.location.href = '/HealthMate/USERPAGE/Home Page/FrontEnd/dashboard.html';  // Redirect to home page
    }
}
...
function handleCredentialResponse(response) {
    ...
    if (isRegistering) {
        ...
        window.location.href = '/HealthMate/USERPAGE/Home Page/FrontEnd/dashboard.html'; // Change to your home URL
    } else {
