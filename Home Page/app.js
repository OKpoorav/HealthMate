...
function loadGoogleCalendar() {
    gapi.client.init({
        apiKey: 'AIzaSyBL2ds9DmwSWbpMURy9r0u6nvWvf_0JRTo',
        clientId: '876080209753-0k7oip0morqa1bk0rlhvfi8oeqn9r4uq.apps.googleusercontent.com',
...
async function loadUserProfile() {
    try {
        const response = await fetch('/Login%20Page/userData.json'); // Path to your JSON file
...
document.removeEventListener('DOMContentLoaded', loadUserProfile); // Clean up duplicate listeners
